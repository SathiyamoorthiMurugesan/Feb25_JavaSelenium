...
//		using or calling a non-static variable
		...
		A4Variables1 obj1 = new A4Variables1();
...
//		using or calling a non-static variable
//		System.out.println(buffelo);
		A4Variables1 obj = new A4Variables1(); // to use a non-static variable inside a static method, we need object for that class
