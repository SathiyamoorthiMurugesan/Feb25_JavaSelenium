...
public class A7VariableAsParameter {
...
//		But we can achieve it using parameters
	...
	public static void main(String[] args) {
		A7VariableAsParameter obj = new A7VariableAsParameter(); // local object
...
//		System.out.println("Bought"   +   soapName    +   "soap");
		/*
		 * String str = "Sathya"; String str1 =
		 * "I am learning java for past 3 years using @gmail"; // I am learning "Java"
		 * for past 3 years using @gmail - I want to print like this in Console //
		 * String str2 = "I am learning "Java" for past 3 years using @gmail"; String
		 * str2 = "I am learning \"Java\" for past 3 years using @gmail"; String str3 =
		 * ""; //Empty String str4 = "    "; //Blank. //In Java, space also considered
		 * as a character. // String str5; String str5 = null; String str6 = "null";
		 */
	}
...
//	* You are filling a form in a web page
