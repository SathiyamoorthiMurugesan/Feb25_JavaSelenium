...
public class A2FinalDemo extends ParentFinal implements FinalInterface {
...
//	final int c;
	...
	public A2FinalDemo(int a) {
		b = 20;
	}

	public static void main(String[] args) {
		A2FinalDemo obj = new A2FinalDemo();
...
//		str1= "Hello";
		...
		ParentFinal obj11 = new A2FinalDemo(); //Override
		obj11.method1();
	}
